...
$TCA['tx_sschhtml5videoplayer_domain_model_video'] = array(
    ...
    'columns' => array(
        ...
        'mp4_source' => array(
            'exclude' => 0,
            'l10n_mode' => 'mergeIfNotBlank',
            'label' => 'LLL:EXT:ssch_html5videoplayer/Resources/Private/Language/locallang_db.xlf:tx_sschhtml5videoplayer_domain_model_video.mp4_source',
            'config' => array(
                'type' => 'input',
                'size' => 255,
                'eval' => 'trim',
        ...
        'web_m_source' => array(
            'exclude' => 0,
            'l10n_mode' => 'mergeIfNotBlank',
            'label' => 'LLL:EXT:ssch_html5videoplayer/Resources/Private/Language/locallang_db.xlf:tx_sschhtml5videoplayer_domain_model_video.web_m_source',
            'config' => array(
                'type' => 'input',
                'size' => 255,
                'eval' => 'trim',
        ...
        'ogg_source' => array(
            'exclude' => 0,
            'l10n_mode' => 'mergeIfNotBlank',
            'label' => 'LLL:EXT:ssch_html5videoplayer/Resources/Private/Language/locallang_db.xlf:tx_sschhtml5videoplayer_domain_model_video.ogg_source',
            'config' => array(
                'type' => 'input',
                'size' => 255,
                'eval' => 'trim',
        ...
        'flash_source' => array(
            'exclude' => 0,
            'l10n_mode' => 'mergeIfNotBlank',
            'label' => 'LLL:EXT:ssch_html5videoplayer/Resources/Private/Language/locallang_db.xlf:tx_sschhtml5videoplayer_domain_model_video.flash_source',
            'config' => array(
                'type' => 'input',
                'size' => 255,
                'eval' => 'trim',
