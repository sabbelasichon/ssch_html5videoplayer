...
$TCA['tx_sschhtml5videoplayer_domain_model_subtitle'] = array(
    ...
    'columns' => array(
        ...
        'track' => array(
            'exclude' => 0,
            'label' => 'LLL:EXT:ssch_html5videoplayer/Resources/Private/Language/locallang_db.xml:tx_sschhtml5videoplayer_domain_model_subtitle.track',
            'config' => array(
                'type' => 'input',
                'size' => 255,
                'eval' => 'trim',
        ...
        'selected' => array(
            'exclude' => 1,
            'label' => 'LLL:EXT:ssch_html5videoplayer/Resources/Private/Language/locallang_db.xml:tx_sschhtml5videoplayer_domain_model_subtitle.selected',
            'config' => array(
                'type' => 'check',
            ),
        ),
